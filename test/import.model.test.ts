...
function fakeApi(options: {
  ...
  const api: RemotesApi = {
    ...
    labelDevice: async () => { throw new Error('the import model must not change a document'); },
    assignButton: async () => { throw new Error('the import model must not change a document'); },
